...
def plot_state_qsphere_mod(quantum_circuit, figsize=None, ax=None, show_state_labels=True,
    ...
    Args:
        ...
        side (str): It's the side of the qsphere to be graphed. 
            This code is designed for a 4-sided pyramid so the side is either "FRONT", "RIGHT", "LEFT" or "BACK".
...
def rotate(x,y,z,side="FRONT"):
    ...
    """ This code is designed for a 4-sided pyramid.
        It creates the right, left and back views of the qsphere by rotating the position of the state circles.
...
def join_images():
    # This code is designed for a 4-sided pyramid.
    # Joins the 4 images of the 4 sides (FRONT, BACK, RIGHT, and LEFT), previously exported into the figures folder, into a single jpg image called hologram.
...
def plot_qsphere_full(quantum_circuit):
    ...
    Here, the size of the points is proportional to the probability
    of the corresponding term in the state and the color represents
    the phase. This code is designed for a 4-sided pyramid.
